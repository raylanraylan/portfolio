...
export const portfolioData = {
    1:{
      ...
      name:'切版（T6）',
      description:'使用Sass(phone:576px以下/Tablet:768px-1200px/Desktop:1200px以上)',
    ...
    2:{
      ...
      name:'TodoList（原生）',
      description:'使用原生Javascript完成基本功能(phone:576px以下/Tablet跟Desktop:576px以上)',
      technology:'',
    ...
    3:{
      ...
      name:'TodoList（Vue）',
      description:'使用從原生版本換成Vue完成基本功能(phone:576px以下/Tablet跟Desktop:576px以上)',
      technology:'',
      ui:'https://hexschool.github.io/THE_F2E_Design/todolist/',
    ...
    4:{
      ...
      name:'模擬競選網站（Vue）',
      description:'The F2E 5th 前端 & UI 修煉精神時光屋，使用UNA設計師所設計的版面(phone:393px/Desktop:1512px)',
